...
import '../Employee/CSS/UpdateEmployee.css'; // Import custom CSS file
...
const UpdateEmployee = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put('/edit_admin/' + id, updatedEmployee)
            .then(result => {
                ...
                <div className="box col-md-6 mt-2" style={{ marginLeft: "-10px" }} >
                    ...
                    <div className="d-flex align-items-center bg-dark rounded justify-content-center pt-3">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className='row'>
                            <div className="col mb-3">
                                <label htmlFor="inputIFSC" className="form-label">IFSC Code</label>
                                <input
                                    type="text"
                                    className="form-control"
                                    id="inputIFSC"
